...
<x-app-layout meta-description="love">
  ...
  <div class="container max-w-4xl mx-auto py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div class="col-span-2 mb-8">
         <h2 class="text-lg sm:text-xl font-bold text-blue-500 uppercase pb-1 border-b-2 border-blue-500">
            Latest Post
         </h2>

        @if ($latesPosts)
        <x-post-items :post="$latesPosts" />
        @endif
        ...
        <div>
            <h2 class="text-lg sm:text-xl mb-4 font-bold text-blue-500 uppercase pb-1 border-b-2 border-blue-500">
                popular  Posts
             </h2>
      ...
      <div>
        <h2 class="text-lg sm:text-xl font-bold text-blue-500 mb-8 uppercase pb-1 border-b-2 border-blue-500">
            Latest Categories
         </h2>
